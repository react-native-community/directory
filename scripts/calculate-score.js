...
// The condition is passed the data and if it returns true, the value is added to the
// libraries score.
//
// The idea is to add to the score for good behavior and subtract from the score for
// bad behavior. It is completely reasonable for no modifiers to match a given library
...
const modifiers = [
  ...
  },
  {
    ...
    value: -20,
    condition: data =>
      data.license && data.license.key && data.license.key.startsWith('gpl'),
  },
  {
