...
function removeEmptyArray(lib: LibraryDataEntry, key: string) {
  return lib[key] && !lib[key].length ? (omit(lib, key) as LibraryDataEntry) : lib;
}

const processedLibraries = (libraries as LibraryDataEntry[])
