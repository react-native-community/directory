  ...
  return (
    <Svg width={24} height={22} viewBox="0 0 22 20" fill="none">
      <Path
        ...
        fill={score >= chunk ? colors.primaryDark : colors.gray3}
      />
      <Path
        ...
        fill={score >= chunk * 2 ? colors.primaryDark : colors.gray3}
      />
      <Path
        ...
        fill={score >= chunk * 3 ? colors.primaryDark : colors.gray3}
      />
      <Path
        ...
        fill={score >= chunk * 4 ? colors.primaryDark : colors.gray3}
      />
      <Path
        ...
        fill={score >= chunk * 5 ? colors.primaryDark : colors.gray3}
      />
      <Path
        ...
        fill={score >= chunk * 6 ? colors.primaryDark : colors.gray3}
      />
